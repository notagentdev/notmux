...
use notmux_git as git;
use notmux_git::repository::{compute_target_paths, normalize_path};
use notmux_ui::button::{button, button_primary};
use notmux_ui::input::input_container;
use notmux_ui::tokens::{ui_text_md, ui_text_ms, ui_text_xl};
use notmux_workspace::settings::{HooksConfig, WorktreeConfig};
...
impl WorktreeDialog {
    pub fn new(
        ...
        let generated_branch = notmux_git::branch_names::generate_branch_name(&git_root);
