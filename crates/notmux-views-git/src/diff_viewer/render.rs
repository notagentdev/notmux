...
impl DiffViewer {
    ...
    pub(super) fn render_commit_info_bar(
        ...
        h_flex()
            ...
            .when_some(commit.cloned(), |d, commit| {
                ...
                let time_str = notmux_git::format_relative_time(commit.timestamp);
                d
    ...
    pub(super) fn render_tree_node(
        ...
        use notmux_files::file_tree::{expandable_file_row_with_options, expandable_folder_row};
