...
/// FS-watcher debounce window (ms). Matches Vryn.
...
pub struct GitStatusWatcher {
    ...
    pr_infos: HashMap<String, Option<vryn_git::PrInfo>>,
    ci_checks: HashMap<String, Option<vryn_git::CiCheckSummary>>,
    any_pending_ci: bool,
    ...
    fn spawn_status_poll(&mut self, cx: &mut Context<Self>) {
        ...
        cx.spawn(async move |this: WeakEntity<Self>, cx| {
            ...
            loop {
                ...
                let new_pr_infos: HashMap<String, Option<vryn_git::PrInfo>> = if check_prs {
