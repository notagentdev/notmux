...
use gpui::*;
use std::sync::Arc;
use vryn_files::code_view::{
    ScrollbarDrag, get_scrollbar_geometry, start_scrollbar_drag, update_scrollbar_drag,
};
use vryn_files::content_search::{ContentSearchConfig, FileSearchResult, SearchHandle, SearchMode};
use vryn_files::project_fs::ProjectFs;
...
use vryn_ui::tokens::{ui_text_ms, ui_text_sm};
