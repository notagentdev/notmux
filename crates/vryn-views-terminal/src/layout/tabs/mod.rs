        ...
        div()
            ...
            .child(
                ...
                .on_click(move |_, _window, cx| {
                    if let Some(ref dispatcher) = ctx_split_v.action_dispatcher {
                        dispatcher.dispatch(
                            vryn_core::api::ActionRequest::SplitTerminal {
            ...
            .child(
                ...
                .on_click({
                    ...
                    move |_, _window, cx| {
                        ...
                        {
                            dispatcher.dispatch(
                                vryn_core::api::ActionRequest::ToggleMinimized {
            ...
            .child(
                ...
                .on_click(move |_, _window, cx| {
                    ...
                    {
                        dispatcher.dispatch(
                            vryn_core::api::ActionRequest::SetFullscreen {
                                    ...
                                    && drag_parent == layout_path_for_drop.as_slice()
                                {
                                        ...
                                        && from_index != i
                                    {
                                        ...
                                        if let Some(ref dispatcher) = dispatcher_for_drop {
                                            dispatcher.dispatch(
                                                vryn_core::api::ActionRequest::MoveTab {
                                    ...
                                    dispatcher.dispatch(
                                        vryn_core::api::ActionRequest::MoveTerminalToTabGroup {
                    ...
                    .on_click({
                        ...
                        cx.listener(move |this, _, window, cx| {
                            ...
                            if !standalone && let Some(ref dispatcher) = dispatcher_for_click {
                                dispatcher.dispatch(
                                    vryn_core::api::ActionRequest::SetActiveTab {
                                        project_id: project_id.clone(),
