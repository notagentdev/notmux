...
// Hook configuration types live in `vryn-state` to keep them GPUI-free.
pub use vryn_state::{HooksConfig, ProjectHooks, TerminalHooks, WorktreeHooks};
...
impl Default for AppSettings {
    fn default() -> Self {
        Self {
            ...
            custom_theme_id: Some(vryn_theme::DEFAULT_THEME_ID.to_string()),
