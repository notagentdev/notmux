...
pub struct ThemeColors {
    ...
    pub syntax_type: u32,
    pub syntax_function: u32,
    pub syntax_property: u32,
    pub syntax_variable: u32,
    pub syntax_operator: u32,
...
pub const DARK_THEME: ThemeColors = ThemeColors {
    ...
    syntax_keyword: 0x569cd6,
    syntax_number: 0xb5cea8,
    syntax_type: 0x4ec9b0,
    syntax_function: 0xdcdcaa,
    syntax_property: 0x9cdcfe,
    syntax_variable: 0x9cdcfe,
    syntax_operator: 0xd4d4d4,
    syntax_punctuation: 0xd4d4d4,
...
pub const LIGHT_THEME: ThemeColors = ThemeColors {
    ...
    syntax_keyword: 0x0000ff,
    syntax_number: 0x098658,
    syntax_type: 0x267f99,
    syntax_function: 0x795e26,
    syntax_property: 0x001080,
    syntax_variable: 0x001080,
    syntax_operator: 0x000000,
    syntax_punctuation: 0x000000,
...
pub const PASTEL_DARK_THEME: ThemeColors = ThemeColors {
    ...
    text_muted: 0x666666,
    syntax_comment: 0x7c7c7c,
    syntax_string: 0xa8ff60,
    syntax_keyword: 0xff73fd,
    syntax_number: 0xc6c5fe,
    syntax_type: 0xffffb6,
    syntax_function: 0x96cbfe,
    syntax_property: 0xc6c5fe,
    syntax_variable: 0xeeeeee,
    syntax_operator: 0xff73fd,
    syntax_punctuation: 0x999999,
...
pub const HIGH_CONTRAST_THEME: ThemeColors = ThemeColors {
    ...
    text_muted: 0xb0b0b0,
    syntax_comment: 0x66ff66,
    syntax_string: 0xffff66,
    syntax_keyword: 0x66b3ff,
    syntax_number: 0x00ffff,
    syntax_type: 0xff66ff,
    syntax_function: 0xffff00,
    syntax_property: 0x66ffff,
    syntax_variable: 0xffffff,
    syntax_operator: 0xffffff,
    syntax_punctuation: 0xe0e0e0,
