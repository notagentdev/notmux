...
use notmux_core::theme::{DARK_THEME, LIGHT_THEME, ThemeColors, ThemeInfo};
...
fn default_term_dim_black() -> String {
    "#333333".to_string()
}
fn default_term_dim_red() -> String {
    "#8b2525".to_string()
}
fn default_term_dim_green() -> String {
    "#0b8c5a".to_string()
}
fn default_term_dim_yellow() -> String {
    "#aba90a".to_string()
}
fn default_term_dim_blue() -> String {
    "#1c5a9e".to_string()
}
fn default_term_dim_magenta() -> String {
    "#8b2e8b".to_string()
}
fn default_term_dim_cyan() -> String {
    "#0c84a2".to_string()
}
fn default_term_dim_white() -> String {
    "#999999".to_string()
}
fn default_term_foreground() -> String {
    "#cccccc".to_string()
}
fn default_term_bright_foreground() -> String {
    "#ffffff".to_string()
}
fn default_term_dim_foreground() -> String {
    "#808080".to_string()
}
...
pub fn load_custom_themes() -> Vec<(ThemeInfo, ThemeColors)> {
    ...
    // Load all JSON files from themes directory (both NotMux-native and VS Code schemas)
