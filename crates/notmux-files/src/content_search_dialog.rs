...
use notmux_ui::badge::keyboard_hint;
use notmux_ui::empty_state::empty_state;
use notmux_ui::file_icon::file_icon;
use notmux_ui::modal::{fullscreen_overlay, modal_backdrop, modal_content, modal_header};
...
use notmux_ui::text_utils::find_word_boundaries;
use notmux_ui::tokens::{ui_text, ui_text_ms, ui_text_sm};

// Local action for closing the dialog
gpui::actions!(notmux_files_content_search, [Cancel]);
...
impl notmux_ui::overlay::CloseEvent for ContentSearchDialogEvent {
