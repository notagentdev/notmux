...
use notmux_ui::simple_input::{InputChangedEvent, SimpleInputState};
...
gpui::actions!(notmux_files, [Cancel]);
...
impl notmux_ui::overlay::CloseEvent for FileSearchDialogEvent {
