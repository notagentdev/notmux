//! notmux-hooks — Lifecycle hook execution.
//!
...
//!
//! This crate intentionally does not depend on `notmux-workspace`: hook
...
pub use hooks::{
    ...
    fire_before_worktree_remove_async, fire_on_dirty_worktree_close, fire_on_project_close,
    fire_on_project_open, fire_on_rebase_conflict, fire_on_worktree_close, fire_on_worktree_create,
