...
use notmux_workspace::state::FolderData;
...
impl Sidebar {
    ...
    fn send_remote_reorder(
        ...
        let server_project_id = notmux_core::client::strip_prefix(prefixed_project_id, conn_id);
            ...
            && let Some(ref send_action) = this.send_remote_action
        {
            (send_action)(
                conn_id,
                notmux_core::api::ActionRequest::ReorderProjectInFolder {
                    folder_id,
                    ...
                    move |this, event: &MouseDownEvent, _window, cx| {
                        this.request_broker.update(cx, |broker, cx| {
                            broker.push_overlay_request(
                                notmux_workspace::requests::OverlayRequest::FolderContextMenu {
                                    folder_id: folder_id.clone(),
                                    folder_name: folder_name.clone(),
