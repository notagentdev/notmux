...
use notmux_ui::badge::keyboard_hints_footer;
use notmux_ui::modal::{modal_backdrop, modal_content, modal_header};
use notmux_ui::theme::theme;
use notmux_ui::tokens::{ui_text, ui_text_md, ui_text_ms};
use notmux_workspace::hook_monitor::{HookExecution, HookMonitor, HookStatus};
...
impl notmux_ui::overlay::CloseEvent for HookLogEvent {
...
notmux_ui::impl_focusable!(HookLog);
