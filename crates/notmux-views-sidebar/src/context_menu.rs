...
use notmux_workspace::requests::ContextMenuRequest;
...
impl notmux_ui::overlay::CloseEvent for ContextMenuEvent {
...
impl Render for ContextMenu {
    fn render(&mut self, window: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        let is_git_repo = notmux_git::is_git_repo(std::path::Path::new(&project_path));
...
notmux_ui::impl_focusable!(ContextMenu);
