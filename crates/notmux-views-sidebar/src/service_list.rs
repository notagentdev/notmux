...
impl Sidebar {
    ...
    pub fn render_services_group_header(
        ...
        .child(notmux_views_services::sidebar::render_service_group_actions(
            &project_id,
            &t,
            cx,
            {
    ...
    pub fn render_service_item(
        ...
        notmux_views_services::sidebar::render_service_item(
            &snapshot,
            &project_id,
            is_cursor,
            left_padding,
                        ...
                        entity.update(cx, |this, cx| {
                            ...
                            this.request_broker.update(cx, |broker, cx| {
                                broker.push_overlay_request(
                                    notmux_workspace::requests::OverlayRequest::ShowServiceLog {
                                        project_id: project_id.clone(),
                                        service_name: service_name.clone(),
                                    },
                                    cx,
            ...
            // on_port_click
            {
                ...
                move |port: u16| {
                    ...
                    notmux_core::process::open_url(&url);
                }
            },
        )
    }
