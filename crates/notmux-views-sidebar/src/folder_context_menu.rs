...
use notmux_workspace::requests::FolderContextMenuRequest;
...
impl notmux_ui::overlay::CloseEvent for FolderContextMenuEvent {
...
notmux_ui::impl_focusable!(FolderContextMenu);
