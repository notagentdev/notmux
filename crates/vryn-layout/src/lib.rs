//! vryn-layout — Layout tree algorithms.
//!
...
pub use vryn_core::types::SplitDirection;
...
impl LayoutNode {
    ...
    #[allow(dead_code)]
    pub fn from_api(api: &vryn_core::api::ApiLayoutNode) -> Self {
        match api {
            vryn_core::api::ApiLayoutNode::Terminal {
                terminal_id,
                minimized,
                detached,
            } => LayoutNode::Terminal {
            ...
            vryn_core::api::ApiLayoutNode::Split {
                direction,
                sizes,
                children,
            } => LayoutNode::Split {
            ...
            vryn_core::api::ApiLayoutNode::Tabs {
                children,
                active_tab,
            } => LayoutNode::Tabs {
                children: children.iter().map(LayoutNode::from_api).collect(),
    ...
    pub fn from_api_prefixed(api: &vryn_core::api::ApiLayoutNode, prefix: &str) -> Self {
        match api {
            vryn_core::api::ApiLayoutNode::Terminal {
                terminal_id,
                minimized,
    ...
    pub fn to_api(&self) -> vryn_core::api::ApiLayoutNode {
        match self {
            LayoutNode::Terminal {
                terminal_id,
                minimized,
