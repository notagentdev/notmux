...
# To install: brew tap contember/vryn-ws && brew install --cask notmux
...
cask "notmux" do
  ...
  url "https://github.com/contember/vryn-ws/releases/download/v#{version}/notmux-macos-#{arch}.zip"
  name "NotMux"
